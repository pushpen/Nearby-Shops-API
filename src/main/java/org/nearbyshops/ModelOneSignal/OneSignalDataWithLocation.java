...
public class OneSignalDataWithLocation {

    public OneSignalDataWithLocation(int notification_type, int screen_to_open) {
        this.notification_type = notification_type;
        this.screen_to_open = screen_to_open;
    }


    public OneSignalDataWithLocation(int notification_type, int screen_to_open, double latCurrent, double lonCurrent, double bearing) {
        this.notification_type = notification_type;
        this.screen_to_open = screen_to_open;
